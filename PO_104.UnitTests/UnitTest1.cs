...
namespace PudelkoUnitTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        public void Area_3params_InMeters_CalculatedCorrectly(double a, double b, double c, double expectedArea)
        {
            var p = new Pudelko(a, b, c);
            
            Assert.AreEqual(expectedArea, p.Area, 0.000_001);
        }
        
        [DataTestMethod, TestCategory("Area")]
        [DataRow(1, 1, 1, 0.0_006)]
        [DataRow(2, 2, 2, 0.0_024)]
        [DataRow(10, 10, 10, 0.06)]
        [DataRow(1, 1, 10, 0.0_042)]
        [DataRow(10, 1, 1, 0.0_042)]
        [DataRow(1, 10, 1, 0.0_042)]

        public void Area_3params_InCentimeters_CalculatedCorrectly(double a, double b, double c, double expectedArea)
        {
        ...
        [DataTestMethod, TestCategory("Area")]
        [DataRow(1, 1, 1, 0.000_006)]
        [DataRow(2, 2, 2, 0.000_024)]
        [DataRow(10, 10, 10, 0.0_006)]
        [DataRow(1, 1, 10, 0.000_042)]
        [DataRow(10, 1, 1, 0.000_042)]
        [DataRow(1, 10, 1, 0.000_042)]

        public void Area_3params_InMillimeters_CalculatedCorrectly(double a, double b, double c, double expectedArea)
        {
        ...
        [DataRow(1, 1, 1, 1)]
        [DataRow(2, 2, 2, 8)]
        [DataRow(10, 10, 10, 1_000)]
        [DataRow(1, 1, 10, 10)]
        [DataRow(10, 1, 1, 10)]
        [DataRow(1, 10, 1, 10)]

        public void Volume_3params_InMeters_CalculatedCorrectly(double a, double b, double c, double expectedVolume)
        {
            var p = new Pudelko(a, b, c);
            
            Assert.AreEqual(expectedVolume, p.Volume, 0.000_000_001);
        }
        
        [DataTestMethod, TestCategory("Volume")]
        [DataRow(1, 1, 1, 0.000_001)]
        [DataRow(2, 2, 2, 0.000_008)]
        [DataRow(10, 10, 10, 0.001)]
        [DataRow(1, 1, 10, 0.000_010)]
        [DataRow(10, 1, 1, 0.000_010)]
        [DataRow(1, 10, 1, 0.000_010)]

        public void Volume_3params_InCentimeters_CalculatedCorrectly(double a, double b, double c, double expectedVolume)
        {
            var p = new Pudelko(a, b, c, UnitOfMeasure.Centimeter);
        ...
        [DataTestMethod, TestCategory("Volume")]
        [DataRow(1, 1, 1, 0.000_000_001)]
        [DataRow(2, 2, 2, 0.000_000_008)]
        [DataRow(10, 10, 10, 0.000_001)]
        [DataRow(1, 1, 10, 0.000_000_010)]
        [DataRow(10, 1, 1, 0.000_000_010)]
        [DataRow(1, 10, 1, 0.000_000_010)]

        public void Volume_3params_InMillimeters_CalculatedCorrectly(double a, double b, double c, double expectedVolume)
        {
            var p = new Pudelko(a, b, c, UnitOfMeasure.Millimeter);
        ...
        [DataTestMethod, TestCategory("Equality members")]
        [DataRow(1, 1, 1, 1, 1, 1)]
        [DataRow(1, 2, 3, 1, 2, 3)]
        [DataRow(1, 2, 3, 3, 2, 1)]
        [DataRow(1, 2, 3, 3, 1, 2)]
        ...
        public void Equality_3params_InMeters(double a1, double b1, double c1, double a2, double b2, double c2)
        {
        ...
        public void Equality_3params_InCentimeters(double a1, double b1, double c1, double a2, double b2, double c2)
        {
            var p1 = new Pudelko(a1, b1, c1, UnitOfMeasure.Centimeter);
            var p2 = new Pudelko(a2, b2, c2, UnitOfMeasure.Centimeter);
        ...
        public void Equality_3params_InMillimeters(double a1, double b1, double c1, double a2, double b2, double c2)
        {
            var p1 = new Pudelko(a1, b1, c1, UnitOfMeasure.Millimeter);
            var p2 = new Pudelko(a2, b2, c2, UnitOfMeasure.Millimeter);
        ...
        [DataTestMethod, TestCategory("Equality members")]
        [DataRow(1, 1, 1, 100, 100, 100)]
        [DataRow(1, 2, 3, 100, 200, 300)]
        [DataRow(1, 2, 3, 300, 200, 100)]
        [DataRow(1, 2, 3, 300, 100, 200)]
        [DataRow(1, 2, 3, 200, 100, 300)]

        public void Equality_3params_InMetersAndCentimeters(double a1, double b1, double c1, double a2, double b2, double c2)
        {
            var p1 = new Pudelko(a1, b1, c1);
            var p2 = new Pudelko(a2, b2, c2, UnitOfMeasure.Centimeter);
        ...
        [DataTestMethod, TestCategory("Equality members")]
        [DataRow(1, 1, 1, 1_000, 1_000, 1_000)]
        [DataRow(1, 2, 3, 1_000, 2_000, 3_000)]
        [DataRow(1, 2, 3, 3_000, 2_000, 1_000)]
        [DataRow(1, 2, 3, 3_000, 1_000, 2_000)]
        [DataRow(1, 2, 3, 2_000, 1_000, 3_000)]

        public void Equality_3params_InMetersAndMillimeters(double a1, double b1, double c1, double a2, double b2, double c2)
        {
            var p1 = new Pudelko(a1, b1, c1);
            var p2 = new Pudelko(a2, b2, c2, UnitOfMeasure.Millimeter);
        ...
        [DataTestMethod, TestCategory("Equality members")]
        [DataRow(100, 100, 100, 1_000, 1_000, 1_000)]
        [DataRow(100, 200, 300, 1_000, 2_000, 3_000)]
        [DataRow(100, 200, 300, 3_000, 2_000, 1_000)]
        [DataRow(100, 200, 300, 3_000, 1_000, 2_000)]
        [DataRow(100, 200, 300, 2_000, 1_000, 3_000)]

        public void Equality_3params_InCentimetersAndMillimeters(double a1, double b1, double c1, double a2, double b2, double c2)
        {
            var p1 = new Pudelko(a1, b1, c1, UnitOfMeasure.Centimeter);
            var p2 = new Pudelko(a2, b2, c2, UnitOfMeasure.Millimeter);
